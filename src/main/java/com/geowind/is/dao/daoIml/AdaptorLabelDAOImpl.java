...
public class AdaptorLabelDAOImpl extends BaseDaoImpl<AdaptorLabel> implements
	...
	public long insertLabelOfImage(AdaptorLabel adaptorLabel) {
		...
		Object[] args = { adaptorLabel.getAlid(),
				adaptorLabel.getConfirmDate(), adaptorLabel.getLabel(),
				adaptorLabel.getPid(), adaptorLabel.getVid(),
				adaptorLabel.getValid() };
	...
	public AdaptorLabel getAdaptorLabel(Integer pid) {
		String sql="select * from adaptorlabel where pid=?";
